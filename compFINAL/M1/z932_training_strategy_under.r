...
PARAM  <- list()
PARAM$experimento <- "3F_TS_M1" # "TS9320"

PARAM$exp_input  <- "2F_FE_M1" # "FE9250"
...
PARAM$train$validation   <- c(   201910,  202009, 202107 )
PARAM$train$testing      <- c(  201910,  202009, 202107 )
