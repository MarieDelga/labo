...
Master_msaldototal #todo lo que le queda por gastar en la tarjeta
Master_msaldopesos
Master_msaldodolares # incluye descuentos
Master_mconsumosdolares # incluye descuentos
