...
ctrl <- setMBOControlTermination(ctrl, iters = 5L) #modificar mas mejor
...
#Time difference of 5.594261 hours
#maxdepth=5; minsplit=1673; fraccionminbucket=0.21
#objective: y = 20498666.667
