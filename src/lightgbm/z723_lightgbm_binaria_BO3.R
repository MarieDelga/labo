...
campos_buenos  <- setdiff( colnames(dataset), c("clase_ternaria","clase01", "azar", "training" ) ) #le quita estos campos

set.seed( PARAM$trainingstrategy$semilla_azar )
dataset[  , azar := runif( nrow( dataset ) ) ] #porque le agrega una columna azar?
dataset[  , training := 0L ] #y porque agrega columna 
...
>>>>>>> 99450eeacd9118946666f769da89e2fdb3d0613d
