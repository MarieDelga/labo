...
PARAM$final_train  <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 
                        ...
                        202104, 202105, 202107)

PARAM$train$training     <- c( 201903,201906,201909,201912,202003,202006,20209, 202012, 202103 )
